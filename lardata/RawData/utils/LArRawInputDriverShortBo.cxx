...
namespace lris {
  ...
  void LArRawInputDriverShortBo::readFile(std::string const& name, art::FileBlock*& fb)
  {
                                          ...
                                          art::EventPrincipal*& outE)
  {
    ...
    art::put_product_in_principal(std::move(rdcolsb), *outE,
                                  "daq"); // Module label
    art::put_product_in_principal(std::move(daqcolsb), *outE,
                                  "daq"); // Module label
